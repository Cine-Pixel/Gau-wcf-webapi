    ...
    public partial class MainForm : Form
    {
        ...
        private void LoadGrid() {
            try
            {
                ...
                string xml = webClient.DownloadString($"{url}/GetAllStudents");

                List<StudentDTO> result = HelpMethods.Deserialize<List<StudentDTO>>(xml);
        ...
        private void BtnDelete_Click(object sender, EventArgs e) {
            try
            {
                ...
                string response = webClient.UploadString($"{url}/DeleteStudent/{id}", 
                    "DELETE",
                    HelpMethods.SerializeToXml<string>(id).OuterXml);
